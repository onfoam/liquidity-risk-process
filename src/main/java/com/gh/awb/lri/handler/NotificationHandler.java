...
/** Sends notifications (placeholder for server extension). Work Item: SendNotification */
public class NotificationHandler implements WorkItemHandler {
    private static final Logger LOG = LoggerFactory.getLogger(NotificationHandler.class);
    private final RuntimeManager runtimeManager;
    public NotificationHandler(RuntimeManager rm) { this.runtimeManager = rm; }

    @Override
    public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
        LOG.info("SendNotification: Executing {}", workItem.getId());
