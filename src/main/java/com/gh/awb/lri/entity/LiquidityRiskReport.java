...
@Entity
@Table(name = "lri_report", uniqueConstraints = @UniqueConstraint(name = "uq_lri_period_ver", columnNames = {"report_year", "quarter_range", "version_number"}))
public class LiquidityRiskReport implements Serializable {
    ...
    public void setReportYear(Integer v) { this.reportYear = v; }
    public String getQuarterRange() { return quarterRange; }
    public void setQuarterRange(String v) { this.quarterRange = v; }
    public Integer getVersionNumber() { return versionNumber; }
    public void setVersionNumber(Integer v) { this.versionNumber = v; }
    public Double getLcrQA() { return lcrQA; }
    public void setLcrQA(Double v) { this.lcrQA = v; }
    public Double getLcrQB() { return lcrQB; }
    public void setLcrQB(Double v) { this.lcrQB = v; }
    public Double getLcrCoverage() { return lcrCoverage; }
    public void setLcrCoverage(Double v) { this.lcrCoverage = v; }
    public Double getNsfrQA() { return nsfrQA; }
    public void setNsfrQA(Double v) { this.nsfrQA = v; }
    public Double getNsfrQB() { return nsfrQB; }
    public void setNsfrQB(Double v) { this.nsfrQB = v; }
    public Double getNsfrCoverage() { return nsfrCoverage; }
    public void setNsfrCoverage(Double v) { this.nsfrCoverage = v; }
    public Double getLeverageQA() { return leverageQA; }
    public void setLeverageQA(Double v) { this.leverageQA = v; }
    public Double getLeverageQB() { return leverageQB; }
    public void setLeverageQB(Double v) { this.leverageQB = v; }
    public Double getLeverageCoverage() { return leverageCoverage; }
    public void setLeverageCoverage(Double v) { this.leverageCoverage = v; }
    public String getEmployeeComment() { return employeeComment; }
    public void setEmployeeComment(String v) { this.employeeComment = v; }
    public String getManagerComment() { return managerComment; }
    public void setManagerComment(String v) { this.managerComment = v; }
    public String getReturnComment() { return returnComment; }
    public void setReturnComment(String v) { this.returnComment = v; }
    public ReportStatus getStatus() { return status; }
    public void setStatus(ReportStatus v) { this.status = v; }
    public Long getProcessInstanceId() { return processInstanceId; }
    public void setProcessInstanceId(Long v) { this.processInstanceId = v; }
